  ...
  const onEditButtonClickHandler =() =>{
    ...
    if(name === '' || price === '' || category === '' || image === ''){
      ...
      if (price <= 0){
        ...
        dispatch({type:'EDIT_PRODUCT', payload:  editedItem})
    ...
    <div className="form">
      <div className="form__input">
        ...
        <div className="form__input__div">
          ...
          <input type="text" id="name" value={name} onChange={e =>onNameInputChangeHandler(e)}/>
        </div>

        <div className="form__input__div">
          <label htmlFor="price">Price:</label>
          <input type="number" id="price" value={price} onChange={e =>onPriceInputChangeHandler(e)}/>
        </div>

        <div className="form__input__div">
          <label htmlFor="image">Image:</label>
          <input type="text" id="image" value = {image} onChange={e => onImageInputChangeHandler(e)}/>
        </div>

        <div className="form__input__div category">
          <select id="category " defaultValue='' onChange={e =>onCategoryInputChangeHandler(e)}>
